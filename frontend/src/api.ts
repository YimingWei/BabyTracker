...
export const api = {
  ...
  updateRecord: (babyId: string, id: string, data: any) => fetchJSON(`/babies/${babyId}/records/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
  deleteRecord: (babyId: string, id: string) => fetchJSON(`/babies/${babyId}/records/${id}`, { method: 'DELETE' }),
  clearHistory: (babyId: string) => fetchJSON(`/babies/${babyId}/history`, { method: 'DELETE' }),
  ...
  updateGrowth: (babyId: string, id: string, data: any) => fetchJSON(`/babies/${babyId}/growth/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
};
